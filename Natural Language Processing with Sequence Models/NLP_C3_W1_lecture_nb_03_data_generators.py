...
print(lines_index)# is equivalent to [i for i in range(0,a_size)], the difference being the advantage of using * to pass values of range iterator to list directly
index = 0                      # similar to index in data_generator below
for i in range(b_size): 
    print(index)# `b` is longer than `a` forcing a wrap
