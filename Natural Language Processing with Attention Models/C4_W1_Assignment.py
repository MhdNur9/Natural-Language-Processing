...
#         - [2.2.1 - Input Encoder](#2-2-1)
#             - [Exercise 1 - input_encoder_fn (UNQ_C1)](#ex-1)
#         - [2.2.2 - Pre-attention Decoder](#2-2-2)
#             - [Exercise 2 - pre_attention_decoder_fn (UNQ_C2)](#ex-2)
#         - [2.2.3 - Preparing the Attention Input](#2-2-3)
#             - [Exercise 3 - prepare_attention_input (UNQ_C3)](#ex-3)
#     - [2.3 - Implementation Overview](#2-3)
#         - [Exercise 4 - NMTAttn (UNQ_C4)](#ex-4)
# - [3 - Training](#3)
#     - [3.1 - TrainTask](#3-1)
#         - [Exercise 5 - train_task_function (UNQ_C5)](#ex-5)
#     - [3.2 - EvalTask](#3-2)
#     - [3.3 - Loop](#3-3)
# - [4 - Testing](#4)
#     - [4.1 - Decoding](#4-1)
#         - [Exercise 6 - next_symbol (UNQ_C6)](#ex-6)
#         - [Exercise 7 - sampling_decode (UNQ_C7)](#ex-7)
#     - [4.2 - Minimum Bayes-Risk Decoding](#4-2)
#         - [4.2.1 - Generating Samples](#4-2-1)
#         - [4.2.2 - Comparing Overlaps](#4-2-2)
#             - [Exercise 8 - rouge1_similarity (UNQ_C8)](#ex-8)
#         - [4.2.3 - Overall Score](#4-2-3)
#             - [Exercise 9 - average_overlap (UNQ_C9)](#ex-9)
#         - [4.2.4 - Putting it all Together](#4-2-4)
#             - [Exercise 10 - mbr_decode (UNQ_C10)](#ex-10)
...
def prepare_attention_input(encoder_activations, decoder_activations, inputs):
    ...
    print(queries, keys, values, mask)
...
def next_symbol(NMTAttn, input_tokens, cur_output_tokens, temperature):
    ...
    padded_with_batch = np.reshape(padded, (1, padded_length))
...
def rouge1_similarity(system, reference):
    ...
    for token in sys_counter:
        ...
        overlap += np.minimum(token_count_sys, token_count_ref)
